...
\begin{itemize}
    ...
    \item Elective courses:
          \begin{itemize}
              \item Biomechanics: mechanical functions of the human body; skeletal adaptations to optimize load transfer, mobility, and function
              \item RFID and its application in manufacturing \& supply chain: study of how RFID is being utilized in manufacturing, with focus on automotive and aerospace.
          \end{itemize}
\end{itemize}
