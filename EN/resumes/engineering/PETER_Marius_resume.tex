...
% \begin{itemize}
%     \item \textbf{Sales}: secured initial funding for an industrial process modelling tool designed for the European aerospace sector
%     \item \textbf{Engineering}: UCLA B.S. Aerospace Eng., 10 year Linux user (desktop, server \& embedded)
%     \item Seeking a \textbf{sales engineering} mission within the American industrial sector for September 2019
% \end{itemize}
...
\item Lead the manufacturing of my team's rocket: mill \& lathe, fiberglass, plywood...
\item We won first place on all criteria: maximum apogee, intact payload, trajectory prediction...
\end{itemize}
\cventry{Apr. 2019--Pres.}{Airfoil Design Software}{Python \url{www.github.com/blendoit/UCLA_MAE_154B}}
\begin{itemize}
\item Design \& optimization of NACA airfoils complying with FAR 23 regulations
\item Ultimate goal: develop an intuitive airfoil creation program, designed for non-technical persons
\end{itemize}
...
\cventry{Dec. 2019}{Linux Foundation Certified Engineer}{Advanced Linux administration and engineering}
\cventry{Mar. 2019}{LEED Green Associate}{Sustainable building design, construction, and operations}
